...
var Zepto = function () {
  ...
  return Y.matches = function (a, b) {
  ...
  }), y.fn = {constructor: Y.Z, length: 0, forEach: C.forEach, reduce: C.reduce, push: C.push, sort: C.sort, splice: C.splice, indexOf: C.indexOf, concat: function () {
    var a, b, c = [];
    ...
    if (this.length) {
      var a = this[0], b = this.offsetParent(), c = this.offset(), d = N.test(b[0].nodeName) ? {top: 0, left: 0} : b.offset();
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (a) {
  ...
  z.href = window.location.href, a.active = 0, a.ajaxJSONP = function (b, c) {
    ...
    A.setRequestHeader = w;
    var C = "async"in i ? i.async : !0;
    if (A.open(i.type, i.url, C, i.username, i.password), A.onreadystatechange = function () {
      if (4 == A.readyState) {
